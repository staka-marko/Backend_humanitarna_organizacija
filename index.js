...
app.get('/korisnik',(req, res)=>{
    mysqlConnection.query('SELECT * FROM hodb.korisnik;',(err, rows, fields)=>{
        if(!err)
        res.send(rows);
        else
        console.log(err);
...
app.post('/korisnik',(req, res)=>{
    mysqlConnection.query('INSERT INTO hodb.korisnik (korisnikID, ime, prezime, jmbg, datumRodjenja, pocetakVolontiranja, email, lozinka, adresaID, clanarinaID, uloga) VALUES (?,?,?,?,?,?,?,?,?,?,?)', [req.body.korisnikID, req.body.ime, req.body.prezime, req.body.jmbg, req.body.datumRodjenja, req.body.pocetakVolontiranja, req.body.email, req.body.lozinka, req.body.adresaID, req.body.clanarinaID, req.body.uloga],(err, rows, fields)=>{
        if(!err)
        res.send('Uspješno dodavanje.');
        else
        console.log(err);
...
app.put('/korisnik',(req, res)=>{
    mysqlConnection.query('UPDATE hodb.korisnik SET korisnikID = ?, ime = ?, prezime = ?, jmbg = ?, datumRodjenja = ?, pocetakVolontiranja = ?, email = ?, lozinka = ?, adresaID = ?, clanarinaID = ?, uloga = ? WHERE korisnikID = ?', [req.body.korisnikID, req.body.ime, req.body.prezime, req.body.jmbg,  req.body.datumRodjenja, req.body.pocetakVolontiranja, req.body.email, req.body.lozinka, req.body.adresaID, req.body.clanarinaID, req.body.uloga, req.body.korisnikID],(err, rows, fields)=>{
        if(!err)
        res.send('Uspješna izmjena.');
        else
        console.log(err);
